def provide_redis_stub():
    raise NotImplementedError("provide_redis_stub() is not implemented")


def provide_session_stub():
    raise NotImplementedError("provide_session_stub() is not implemented")


def provide_current_user_stub():
